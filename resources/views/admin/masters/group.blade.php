                                        ...
                                        <table class="table table-responsive table-bordered" id="dynamicAddRemove">
                                            ...
                                            <tbody id="addMore">
                                                <tr>
                                                    ...
                                                    <td><input type="file" name="document[]" class="form-control" required multiple="" id="document"></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="file" name="document[]" class="form-control" required multiple="" id="document">
                                                        <span class="text-danger is-invalid name_err"></span>
                                                    </td>
                                                </tr>
...
<script>
    $(document).ready(function() {
        ...
        function addMoreForm() {
            ...
            if(rowId < 3)
                tr += '<td><input type="file" name="document[]" required class="form-control" ></td>';
